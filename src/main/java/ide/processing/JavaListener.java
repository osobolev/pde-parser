...
public interface JavaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#activeProgram}.
	 * @param ctx the parse tree
	 */
	void enterActiveProgram(JavaParser.ActiveProgramContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#activeProgram}.
	 * @param ctx the parse tree
	 */
